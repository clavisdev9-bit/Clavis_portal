...
const OutstandingTTFTable = () => {
    ...
    const columns = [
        ...
        { label: "SI No", index: 7, default:true },
        { label: "SI Date", index: 8, default:false },
        { label: "Cust GR No", index: 9, default:false },
        { label: "Tgl.Kirim Inv", index: 10, default:false },
        { label: "Tgl. JT Bayar", index: 11, default:false },
        { label: "Kwitansi No", index: 12, default:false },
        { label: "TTF No", index: 13, default:false },
        { label: "Tgl. Terima Inv", index: 14, default:false },
        { label: "Inv AWB No", index: 15, default:false },
        { label: "Customer", index: 16, default:false },
        { label: "Customer Alias", index: 17, default:false },
        { label: "DC Name", index: 18, default:false },
        { label: "Area", index: 19, default:false },
        { label: "Total SKU", index: 20, default:false },
        { label: "Qty SO", index: 21, default:false },
        { label: "Qty SO CTN", index: 22, default:false },
        { label: "Qty GR", index: 23, default:false },
        { label: "Qty GRN CTN", index: 24, default:false },
        { label: "Qty SI", index: 25, default:false },
        { label: "Qty SI CTN", index: 26, default:false },
        { label: "Amt Bef. Tax", index: 27, default:false },
        { label: "Messages", index: 28, default:false },
    ];
                    ...
                    <div class="col-span-12 2xl:col-span-12 order-[17] card">
                        ...
                        <div className="relative overflow-x-auto w-full">
                            ...
                            <div className={`${loading ? "blur-sm pointer-events-none" : ""}`}>
                                <table id="outstandingTTFTable" className="min-w-full table-auto">
