                        ...
                        <div class="grid grid-cols-2 content-between mb-2">
                            ...
                            <div class="flex justify-end gap-1" ref={filterRef}>
                                ...
                                <div className="relative">
                                    ...
                                    {showColumn && (
                                        <div className="absolute min-w-96 mt-2 right-0 bg-white dark:bg-slate-800 border border-gray-200 rounded-lg shadow-xl p-4 z-50 whitespace-nowrap text-black dark:text-black">
