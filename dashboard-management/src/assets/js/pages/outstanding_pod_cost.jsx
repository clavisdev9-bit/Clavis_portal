...
const OutstandingPODCostTable = () => {
    ...
    const columns = [
        ...
        { label: "SI No", index: 5, default:true },
        { label: "SI Date", index: 6, default:true },
        { label: "Shipment Date", index: 7, default:true },
        { label: "Driver", index: 8, default:false },
        { label: "AWB No", index: 9, default:false },
        { label: "Service Name", index: 10, default:false },
        { label: "POD Leadtime", index: 11, default:false },
        { label: "Est. POD", index: 12, default:false },
        { label: "POD Status", index: 13, default:false },
        { label: "POD Elapse", index: 14, default:false },
        { label: "POD Doc Leadtime", index: 15, default:false },
        { label: "Est. POD Doc", index: 16, default:false },
        { label: "POD Doc Status", index: 17, default:false },
        { label: "POD Doc Elapse", index: 18, default:false },
        { label: "DO Date", index: 19, default:false },
        ...
        { label: "DO Amt Bef. Tax", index: 25, default:false },
        { label: "Qty SO", index: 26, default:false },
        { label: "Qty SO CTN", index: 27, default:false },
        { label: "Qty GR", index: 28, default:false },
        { label: "Qty GR CTN", index: 29, default:false },
        { label: "Qty DO", index: 30, default:false },
        { label: "Qty DO CTN", index: 31, default:false },
        { label: "Cust GR No", index: 32, default:false },
        { label: "CM3", index: 33, default:false },
        { label: "CBM", index: 34, default:false },
        { label: "CW", index: 35, default:false },
        { label: "Courier Last Status", index: 36, default:false },
        { label: "Courier Last Station", index: 37, default:false },
                    ...
                    <div class="col-span-12 2xl:col-span-12 order-[17] card">
                        ...
                        <div className="relative overflow-x-auto w-full">
                            ...
                            <div className={`${loading ? "blur-sm pointer-events-none" : ""}`}>
                                <table id="outstandingPODCostTable" className="min-w-full table-auto">
