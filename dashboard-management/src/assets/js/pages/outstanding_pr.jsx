...
const OutstandingPRTable = () => {
    ...
    const columns = [
        ...
        { label: "Customer", index: 3, default:true },
        { label: "Ship To", index: 4, default:true },
        { label: "SO Date", index: 5, default:true },
        { label: "Cancelled Date", index: 6, default:true },
        { label: "Product Code", index: 7, default:true },
        { label: "Doc Type", index: 8, default:false },
        { label: "Qty Doc", index: 9, default:false },
        { label: "Qty Cancelled", index: 10, default:false },
        { label: "Std Pack", index: 11, default:false },
        { label: "Qty Doc CTN", index: 12, default:false },
        { label: "Qty Cancelled CTN", index: 13, default:false },
        { label: "Cancel Code", index: 14, default:false },
        { label: "Cancel Desc", index: 15, default:false },
        { label: "Cancel Remark", index: 16, default:false },
        { label: "Return To MTI", index: 17, default:false },
        { label: "Messages", index: 18, default:false },
    ];
                    ...
                    <div class="col-span-12 2xl:col-span-12 order-[17] card">
                        ...
                        <div className="relative overflow-x-auto w-full">
                            ...
                            <div className={`${loading ? "blur-sm pointer-events-none" : ""}`}>
                                <table id="outstandingPRTable" className="min-w-full table-auto">
