...
const InvoiceTable = () => {
    ...
    useEffect(() => {
        ...
        const url = `${__API_URL__}/invoices/master${
    ...
    useEffect(() => {
        if (!tableRef.current) {
            tableRef.current = $('#invoiceTable2').DataTable({
                data: invoiceData,
                columns: [
                    {
                        data: null,
            ...
            tableRef.current.rows.add(invoiceData);
                    ...
                    <div class="col-span-12 2xl:col-span-12 order-[17] card">
                        ...
                        <div className="relative w-full">
                            ...
                            <div className={`${loading ? "blur-sm pointer-events-none" : ""}`}>
                                <table id="invoiceTable2" className="min-w-full table-auto">
...
const root = ReactDOM.createRoot(
    document.getElementById("invoice_2")
);
