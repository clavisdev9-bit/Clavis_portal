...
const OutstandingDisptachTable = () => {
    ...
    const defaultColumns = [1,2,3,4,5,6,7,8,9];
    ...
    const selectableColumns = columns
        .map(col => col.index)
        .filter(index => !lockedColumns.includes(index));

    const allChecked = selectableColumns.every(index =>
    ...
    const handleCheckAll = () => {
        ...
        if (allChecked) {
            ...
            // reset ke default column
            setVisibleColumns(defaultColumns);

        } else {

            // tampilkan semua + locked
                                ...
                                <div className="relative">
                                    ...
                                    {showColumn && (
                                        <div className="absolute min-w-96 mt-2 right-0 bg-white dark:bg-slate-800 border border-gray-200 rounded-lg shadow-xl p-4 z-50 whitespace-nowrap">
                                            <label className="flex items-center border-b pb-2 font-semibold cursor-pointer text-black">
                                                <input
                                                    type="checkbox"
                                                    checked={allChecked}
                                            ...
                                            <div className="flex gap-3">
                                                <div className="flex-1 flex flex-col">
                                                    {col1.map(col => (
                                                        <label key={col.index} className="flex items-center cursor-pointer text-black">
                                                            <input
                                                                type="checkbox"
